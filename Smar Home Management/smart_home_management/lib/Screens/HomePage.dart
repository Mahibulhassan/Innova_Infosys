                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment
                                          .spaceEvenly,
                                      children: [
                                        HomeTopView(size, Icons.water_drop, "97 %",
                                            "Humadit"),
                                        HomeTopView(
                                            size, Icons.remove_red_eye, "7 Km",
                                            "Visibility"),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  HomeMiddleView(size, "19 C", "Living Room", "5 Device",
                                      "assets/sufa.png"),
                                  HomeMiddleView(size, "12 C", "BedRoom", "8 Device",
                                      "assets/sufa.png")
                                ],
                              ),
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                HomeLowerView(
                                    size, "Temparature", "19 C", "Ac", "Living Room",
                                    "assets/ac.png"),
                                HomeLowerView(
                                    size, "Colour", "White", "Lamp", "Dining Room",
                                    "assets/ac.png"),
                              ],
                            ),
                          ],
