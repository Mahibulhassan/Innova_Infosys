                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                  children: [
                                    HomeTopView(size,Icons.water_drop,"97 %","Humadit"),
                                    HomeTopView(size,Icons.remove_red_eye,"7 Km","Visibility"),
                                    HomeTopView(size,Icons.wind_power_outlined,"3 km/h","NE Wind")
                                  ],
                                ),
                              ),
